...
e.prototype.init = function(t, n) {
	...
	let l = window.innerWidth, u = window.innerHeight, d = this.wrapper.offsetWidth, f = this.wrapper.offsetHeight;
	return t + d > l && (t = l - d - 10), n + f > u && (n = u - f - 10), this.wrapper.style.left = `${t}px`, this.wrapper.style.top = `${n}px`, this.wrapper.querySelectorAll(".boc-has-submenu").forEach((e) => {
		e.addEventListener("mouseenter", () => {
			var t = e.querySelector(".boc-submenu");
			if (t) {
				t.classList.remove("boc-submenu-left"), t.classList.remove("boc-submenu-top");
				var n = t.getBoundingClientRect(), r = window.innerWidth, i = window.innerHeight;
				n.right > r && t.classList.add("boc-submenu-left"), n.bottom > i && t.classList.add("boc-submenu-top");
			}
		});
	}), !0;
	...
	return e.events.on(t, n, this._event_id), this;
}, e.menuUI._createMenuElement = function(t, n) {
	var r = document.createElement("div");
	r.classList.add("boc-menu"), r.setAttribute("data-menu", ""), r.id = "custom-boc-menu";
	var i = document.createElement("table");
	return i.classList.add("boc-menu-options"), i.setAttribute("cellpadding", "0"), i.setAttribute("cellspacing", "0"), e.menuUI._createMenuItemElements(t, i), r.appendChild(i), n.element.appendChild(r), r;
}, e.menuUI._createMenuItemElements = function(t, n) {
	for (var r in t) {
		var i = t[r], a = document.createElement("tr");
		a.classList.add("boc-menu-item"), a.setAttribute("data-item", r);
		var o = document.createElement("td");
		if (o.classList.add("boc-menu-submenu"), i.subMenu) {
			var s = document.createElement("table");
			s.setAttribute("cellpadding", "0"), s.setAttribute("cellspacing", "0"), s.classList.add("boc-submenu"), e.menuUI._createMenuItemElements(i.subMenu, s), a.classList.add("boc-has-submenu"), o.appendChild(s);
		}
		var c = i.text, l = i.icon, u = i.shortcut;
		l === void 0 && (l = e.icon[r] ? typeof e.icon[r] == "function" ? e.icon[r](24, 24, "#7A7A7A") : e.icon[r] : ""), typeof c == "function" ? c = c() : c ||= r, typeof l == "function" && (l = l());
		var d = document.createElement("td");
		d.classList.add("boc-menu-icon"), d.innerHTML = l || "", a.appendChild(d);
		var f = document.createElement("td");
		f.classList.add("boc-menu-text"), f.textContent = c, a.appendChild(f);
		var p = document.createElement("td");
		if (p.classList.add("boc-menu-shortcut"), i.subMenu ? p.innerHTML = "<span class=\"boc-submenu-arrow\">▶</span>" : p.textContent = u || "", a.appendChild(p), a.appendChild(o), n.appendChild(a), i.devider) {
			var m = document.createElement("tr");
			m.classList.add("boc-menu-divider"), m.innerHTML = "<td colspan=\"3\"><div class=\"boc-menu-line\"></div></td>", n.appendChild(m);
		}
	}
